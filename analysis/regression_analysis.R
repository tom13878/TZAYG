...
# quadratic form
ols8 <- lm(output.kgh.new ~ nitrogen.kgh + I(nitrogen.kgh * nitrogen.kgh) + area +
                   area2 + aoh + log(tot.cap.shh) + fam.lab.daysh + soh + soilq +
                   irrigation + pest + beans + inter.crop + seed.type,
           data = db3)
